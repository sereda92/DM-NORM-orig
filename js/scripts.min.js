/*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
	...
	b.filter = function (e, t, n) {
		...
		is: function (e) {
			return !!j(this, "string" == typeof e && $.test(e) ? b(e) : e || [], !1).length
		}
	});
	var D, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
	...
	function Le(e, t, n, i) {
		...
		if (p && (r = (o = ge(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
			for (l = (a = b.map(fe(o, "script"), De)).length; u < p; u++) c = o, u !== f && (c = b.clone(c, !0, !0), l && b.merge(a, fe(c, "script"))), n.call(e[u], c, u);
			if (l)
	...
	Lt.href = yt.href, b.extend({
		...
		ajax: function (t, n) {
			...
			if (y.promise(S), h.url = ((t || h.url || yt.href) + "").replace(Dt, yt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(P) || [""], null == h.crossDomain) {
				c = i.createElement("a");
				try {
